...
public class KeyBuilder implements Cloneable {
    ...
    public void parseLine(String line, final boolean checkIfExists) {
        line = line.trim();
    ...
    public void removeLastKey() {
        ...
        final String keyString = builder.toString();
        ...
        final int minIndex = Math.max(0, builder.length() - split[split.length - 1].length() - 1);
